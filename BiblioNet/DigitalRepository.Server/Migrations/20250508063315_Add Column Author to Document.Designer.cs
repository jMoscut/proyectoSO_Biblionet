...
namespace DigitalRepository.Server.Migrations
{
    ...
    [Migration("20250508063315_Add Column Author to Document")]
    partial class AddColumnAuthortoDocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalRepository.Server.Entities.Models.Document", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DigitalRepository.Server.Entities.Models.Download", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DigitalRepository.Server.Entities.Models.Document", b =>
                {
                    b.HasOne("DigitalRepository.Server.Entities.Models.User", "User")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("DigitalRepository.Server.Entities.Models.Download", b =>
                {
                    b.HasOne("DigitalRepository.Server.Entities.Models.Document", "Document")
                        .WithMany("Downloads")
